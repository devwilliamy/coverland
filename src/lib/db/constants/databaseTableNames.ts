...
export const PRODUCT_REVIEWS_TABLE = 'reviews-2_20240603';
...
export const RPC_GET_DISTINCT_REVIEW_IMAGES = 'get_distinct_review_images_20240603';
export const RPC_GET_PRODUCT_REVIEWS_SUMMARY = 'get_product_reviews_summary_20240603';
