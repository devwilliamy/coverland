...
export const PRODUCT_DATA_TABLE = 'Products_20240617';
export const RELATIONS_PRODUCT_TABLE = 'relations_product_20240617';
...
/* Supabase RPC Names */
export const RPC_GET_MAKE_RELATION = 'get_make_relation_20240617';
export const RPC_GET_UNIQUE_YEARS = 'get_unique_years_20240617';
export const RPC_GET_SEAT_COVER_SORTED_BY_COLOR =
  'get_seat_cover_products_sorted_by_color_20240617';
