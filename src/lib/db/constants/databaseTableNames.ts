...
export const ADMIN_PANEL_ORDERS = process.env.IS_PREVIEW === "PREVIEW" ? '_Orders_TEST' : '_Orders'
export const ADMIN_PANEL_ORDER_ITEMS =  process.env.IS_PREVIEW === "PREVIEW" ? 'orderItems_table_TEST' : "orderItems_table"
