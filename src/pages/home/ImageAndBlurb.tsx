...
export default function ImageAndBlurb() {
  return (
    <section className="flex h-auto w-screen max-w-[1440px] flex-col  bg-white pb-12 lg:pb-20">
      <div className="xxl:px-0 flex w-full flex-col items-center justify-center px-4 lg:flex-row-reverse lg:px-20">
        ...
        <div className="mb-5 mt-5 flex w-full flex-col items-start justify-center md:w-3/4 lg:w-2/4">
          <h1 className="flex h-1 w-full text-black ">
            Custom-Fit Car Covers Designed In The USA
          </h1>
          <p className="">
