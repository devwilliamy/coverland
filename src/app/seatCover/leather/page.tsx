  ...
  const YourComponent = () => {
    ...
    const fetchData = async (id: any) => {
      try {
        ...
        setProductDataImage(
          response.product.length > 0 ? response.product.split(',') : []
        );
        const cartProduct = modelDataProduct.find(
          (p) => p.display_color === color
        );
      } catch (error) {
    ...
    return (
      <div>
              ...
              <div className="row">
                <div className="col-md-6 mob-pad-zero">
                  <div className={styles.detailProductLeft}>
                    ...
                    <div className="mobile_gallery">
                      <div className="row">
                        {productDataImage
                          .slice(0, showAllImages ? undefined : maxImagesToShow)
                          .map((item, index) => (
                        ...
                        <div className="col-md-6">
                          <div className={styles.recoImagesVideo}>
                            <h5>
                              <span>More</span> Customer Images
                            </h5>
                            <button onClick={handleShowAllImages}>
                              {' '}
                              <Image src={camera} alt="" /> See All photo
                            </button>
                          </div>
                        </div>
                      </div>
                ...
                <div className="col-md-6">
                  <div className={styles.detailProductRight}>
                    ...
                    <span>
                      <Image src={star} alt="" /> 1315{' '}
                    </span>
                    <div className={styles.ProductPrice}>
                      <h6>From</h6>
                      <h5>
                        ${modelDataProduct.price}{' '}
                        <span>${modelDataProduct.msrp}</span>
                        <label>(-50%)</label>
                      </h5>
                      <p>
                        4 interest-free installments of <span> $24.99 </span>{' '}
                      ...
                      <ul>
                        {productDataColor.map((item) => (
                          <li
                            className={
                              item.display_color ==
                              modelDataProduct.display_color
                                ? styles.active
                                : 'color-uniq-li'
                            }
                            onClick={() => {
                          ...
                          >
                            <span>
                              <Image
                                src={
                                  item.display_color == 'Solid Gray'
                                    ? clthree
                                    : item.display_color == 'Solid Black'
                                      ? clone
                                      : cltwo
                                }
                                alt=""
                      ...
                      <ul>
                        <li>
                          ...
                          <div>
                            ...
                            <p>
                              Order within 9 hours 3 mins - Receive by Feb 20{' '}
                            </p>
                          </div>
        ...
        <div className={styles.staySafe}>
          <div className="container">
            <div className={styles.staySafecontainer}>
              ...
              <h6>
                From <span>Kids</span> and <span>Pets</span> to{' '}
                <span>Spilled</span> Drinks, Your Seats Remain Spotless.
              </h6>
        ...
        <div
          className={styles.safestSteps}
          style={{ backgroundImage: `url(${seatbk.src})` }}
        >
          <div className="container">
        ...
        <div className={styles.waranty}>
          <div className="container">
            ...
            <ul>
              <li>
                <b>All Damage Covered:</b> Beyond factory defects.
              </li>
              <li>
                <b>Normal Wear:</b> Covers daily use impacts.
              </li>
              <li>
                <b>Effortless Claims: </b>Easy, no questions asked.
              </li>
            </ul>
          </div>
        </div>
