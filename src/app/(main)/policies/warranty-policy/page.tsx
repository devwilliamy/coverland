        ...
        <div className="relative px-5 py-8 lg:py-[70px] ">
          ...
          <ol>
            ...
            <li>
              ...
              accidents happen. If your product rips or tears during normal
              usage, we will replace it.
            </li>
          </ol>
          <PolicyDetail>
          ...
          <PolicyDetail>
            ...
            team via phone or email, providing your purchase details and a brief
            ...
            replacement process. Replacement: A replacement cover will be sent
            to you at no additional cost, except for shipping.
          </PolicyDetail>
          <div className="pt-5"></div>
