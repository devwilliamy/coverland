...
import img from '@/images/PDP/zero_leaks.jpg';
    ...
    <div className="relative">
      ...
      <PolicyDetailItem title="Introduction">
        <p className="text-lg font-thin">
          At Coverland, we aim to ensure that you are completely satisfied with
          your purchase. This policy outlines the conditions under which returns
          and refunds are processed. Coverland reserves the right to change this
          info at any time and without notice.
        </p>
      </PolicyDetailItem>
      <PolicyDetailItem title="Return Eligibility">
        ...
        <li className=" text-lg font-thin">
          Returns must be initiated within 5 business days of the delivery date.
        </li>
      </PolicyDetailItem>
      <PolicyDetailItem
...
"
      >
        <p>
          Refunds are only available for products that are returned unopened and
          in their original condition. Once we receive and inspect the returned
          item, we will notify you of the approval or rejection of your refund.
          If approved, the refund will be processed, and a credit will
          automatically be applied to your original method of payment within 5
          business days.
        </p>
      </PolicyDetailItem>
