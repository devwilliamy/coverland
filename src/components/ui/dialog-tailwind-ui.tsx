      ...
      <HeadlessDialog as="div" className="relative z-10" onClose={setOpen}>
        ...
        <div className="z-100 fixed inset-0 w-screen overflow-y-auto">
          <div className=" max-h-[75vh] min-h-[50vh] items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <HeadlessDialog.Panel className="relative z-[100] transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                <div>
                  <div className="mt-3 text-center sm:mt-5">
                    <HeadlessDialog.Title
                      as="h3"
                      className="flex flex-row text-base font-semibold leading-6 text-gray-900"
                    >
