...
export function ProductPackage() {
  return (
    <div className="flex w-full flex-col">
      <div className="  h-[137px] w-full flex-col text-center text-[45px] font-black uppercase lg:flex ">
        Specifications
      </div>
          ...
          <div className="grid grid-cols-1 gap-10 pt-8 lg:pt-20">
            ...
            <div className="flex flex-row items-start justify-start">
              ...
              <div className="mt-1 grid grid-cols-1 gap-2 px-8">
                ...
                <p className="w-full text-base font-normal text-[#767676] md:w-[521px] md:text-lg">
                  Anxious that the cover {`won't`} fit because of the antenna?
                  The antenna patch and grommets are here to help to create an
                  antenna hole in the antenna location.
                </p>
              </div>
            </div>
            <div className="flex flex-row items-start justify-start">
