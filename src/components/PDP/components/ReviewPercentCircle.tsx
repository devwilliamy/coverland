...
export default function ReviewPercentCircle({
  ...
  return (
    <div className="relative h-[75px] w-[75px] lg:h-[135px] lg:w-[135px]">
      <svg
        width="137"
        height="135"
        viewBox="0 0 137 135"
        ...
        className="relative h-[75px] w-[75px] lg:h-[135px] lg:w-[135px]"
      >
        <path
      ...
      <p className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-2xl font-black text-green-700 lg:text-4xl">
        {percent}
      </p>
    </div>
  );
