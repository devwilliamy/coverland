...
const StarIcon = ({ height, width }: { height?: string; width?: string }) => (
  <svg
    width={width || '59'}
    height={height || '55'}
    viewBox="0 0 59 55"
...
const ReviewSection = ({
  ...
  return (
    <>
      <p className="text-black text-center font-black sm:text-xl md:text-3xl lg:text-[42px] mb-20 uppercase">
        Car Cover Reviews
      </p>
      <div className="flex justify-around items-center">
        <div className="flex flex-col items-center">
          <div className="flex items-center gap-2">
            <p className="text-[80px] font-black">4.9</p>
            <p className="mt-11">{reviewData?.length} reviews</p>
          </div>
        ...
        <div className="flex items-center gap-2">
          <div
            style={{ position: 'relative', width: '137px', height: '135px' }}
          >
            <svg
              width="137"
              height="135"
            ...
            <p className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-4xl font-black text-green-700">
              95%
            </p>
          </div>
          <p className="text-[28px]">would recommend</p>
        </div>
      </div>
